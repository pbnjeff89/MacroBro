...
from app.forms import LoginForm, RegistrationForm, RecipeForm, RecipeEditForm, IngredientEditForm, IngredientSearchForm, IngredientSearchResultsForm, AddIngredientForm, ResetPasswordRequestForm, ResetPasswordForm
...
def add_ingredient_to_recipe():
    ...
    return render_template('add_ingredient_to_recipe.html', add_ingredient_form=add_ingredient_form, ingredient=ingredient)
